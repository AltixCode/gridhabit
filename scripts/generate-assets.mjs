#!/usr/bin/env node
/**
 * Generates every brand asset from one source of truth: the contribution grid.
 *
 ...
 */
const MARK = [
  [0.12, 0.12, 0.12, 0.45, 1.0],
  [0.12, 0.12, 0.45, 1.0, 1.0],
  [0.12, 0.45, 1.0, 1.0, 0.45],
  [0.45, 1.0, 1.0, 0.45, 0.12],
  [1.0, 1.0, 0.45, 0.12, 0.12],
];
...
console.log('Generating GridHabit brand assets\n');
